...
function accumulateStagesBySteps(stages: Readonly<Stage[]>): Stage[] {
  return accumulate(
      stages,
...
function currentStage(zone: Readonly<Zone>, steps: number): StageAndIndex {
...
function isCheckpoint(zone: Readonly<Zone>, steps: number): boolean {
